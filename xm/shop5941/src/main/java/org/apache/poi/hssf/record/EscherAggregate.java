...
//		byte buffer[] = new byte[ ];
		...
		ContinueRecord drawingRecord ;
		while (records.get( loc )!=null) {
			try {
				drawingRecord =  (ContinueRecord) records.get( loc );
				System.arraycopy( drawingRecord.getData(), 0, buffer, offset, drawingRecord.getData().length );
				offset += drawingRecord.getData().length;
				loc += 2;
			} catch (Exception e) {
...
//		ContinueRecord drawingRecord =  (ContinueRecord) records.get( 119 );
//		System.arraycopy( drawingRecord.getData(), 0, buffer, offset, drawingRecord.getData().length );
//		offset += drawingRecord.getData().length;
//		loc += 2;
//		 drawingRecord =  (ContinueRecord) records.get( 121 );
//		System.arraycopy( drawingRecord.getData(), 0, buffer, offset, drawingRecord.getData().length );
//		offset += drawingRecord.getData().length;
//		loc += 2;
