...
public class Gd extends BaseEN{
	private Long id; //id
	...
	public String toString() {
		return "Gdid" + id + "1shoponeid" + shoponeid + "1shopone" + shopone + "1shopto" + shopto + "1shop" + shop
				+ "1systemone" + systemone + "1clerk" + clerk + "1jing_xiao_shang" + jing_xiao_shang
