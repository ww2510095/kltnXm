...
//            Application.out(pushPayload);
//            PushResult pushResult=jPushClient.sendPush(pushPayload);
//            Application.out(pushResult);
...
//        Application.out("----------buildPushObject_android_registrationId_alertWithTitle");
//        return PushPayload.newBuilder()
//                //指定要推送的平台，all代表当前应用配置了的所有平台，也可以传android等具体平台
...
//        Application.out("----------buildPushObject_ios_registrationId_alertWithTitle");
//        return PushPayload.newBuilder()
//                //指定要推送的平台，all代表当前应用配置了的所有平台，也可以传android等具体平台
